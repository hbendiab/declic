...
export const Component = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const newSection = Math.min(Math.floor(progress * totalSections), 3);
      ...
      const cameraPositions = [
        { x: 0, y: 30, z: 300 },    // Section 0 - DÉCOUVRE
        { x: 0, y: 40, z: -50 },     // Section 1 - DÉCIDE
        { x: 0, y: 50, z: -700 },    // Section 2 - DÉCLIK
        { x: 0, y: 60, z: -1200 }    // Section 3 - ROBOT
      ];
  ...
  return (
    <div ref={containerRef} className="hero-container cosmos-style">
      ...
      {/* Main content - dynamique selon currentSection */}
      {(() => {
        const titles = {
          0: 'DÉCOUVRE',
          1: 'DÉCIDE',
        ...
        const subtitles = {
          0: {
            line1: 'Ton vrai potentiel',
            line2: ''
          },
          1: {
            line1: 'quel chemin te plaît',
            line2: ''
          },
          2: {
            line1: 'Connais-toi.',
            line2: 'Trouve ta voie.'
          }
        };

        if (currentSection === 3) {
          return (
            <div style={{ position: 'fixed', inset: 0, zIndex: 5, overflowY: 'auto', padding: '2rem' }}>
              <SplineSceneBasic />
            </div>
          );
        }

        const s = currentSection as 0 | 1 | 2;
        const title = titles[s] ?? titles[0];
        const subtitle = subtitles[s] ?? subtitles[0];
        ...
        return (
          <div className="hero-content cosmos-content">
            ...
            <div ref={subtitleRef} className="hero-subtitle cosmos-subtitle">
              <p className="subtitle-line" style={s === 2 ? { color: '#8b0000' } : undefined}>{subtitle.line1}</p>
              <p className="subtitle-line" style={s === 2 ? { color: '#8b0000' } : undefined}>{subtitle.line2}</p>
            </div>
          </div>
        );
      })()}
      ...
      {/* Spacers invisibles pour créer la hauteur de scroll */}
